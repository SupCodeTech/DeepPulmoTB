...
def main():
  ...
  parser.add_argument('Caverns_Detection_Train_Bboxes_cvs', help='Caverns detection or report train bboxes cvs')
  parser.add_argument('Original_Image_Dataset', help='Original image dataset path')
  parser.add_argument('Caverns_Detection_Train_Masks1', help='Caverns detection train masks1 path')
  parser.add_argument('Caverns_Detection_Train_Masks2', help='Caverns detection train masks2 path')
  ...
  data_pd_ = pd.read_csv(args.Caverns_Detection_Train_Bboxes_cvs)
  ...
  for files_num in range(558):
    ...
    src_mask1_ = nib.load(args.Caverns_Detection_Train_Masks1 + "/" + nill_file + '_mask.nii.gz')

    src_mask1 = src_mask1_.get_fdata()

    src_mask1 = src_mask1.transpose(2,1,0)

    src_mask2_ = nib.load(args.Caverns_Detection_Train_Masks2 + "/" + nill_file + '_regsegm_py.nii.gz')
